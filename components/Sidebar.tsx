...
const Sidebar = () => {
  return (
    <div>
      <Image src={Img} alt="Photo of Jacob Maier" className="w-32 h-32 mx-auto border-2 border-green-500 rounded-full"/>
      ...
      <a 
        className='flex px-2 py-1 my-3 bg-gray-200 rounded-full justify-center'
        href="/assets/JacobMaierResume.pdf" download>
